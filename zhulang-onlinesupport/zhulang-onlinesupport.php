...
//        $this->option_name_html    = $this->option_prefix . '_html';
    ...
    public function showFrame() {
        ...
        echo '<ul class="overz">';
        echo "<li><a target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin=$qq_number_1&site=qq&menu=yes'><img border='0' src='http://wpa.qq.com/pa?p=2:12345678:51' alt=$qq_number_1 title=$slogan></a></li>";
    ...
    public function topMenuHtml() {
        ...
        echo '<p style="font-weight:bold;">在此处对在线客服进行设置（4个QQ可以设置为同一个）。</p>';
        echo "<p>联系QQ1：<input type='text' name='qq_number_1' value='$qq_number_1'></p>";
        ...
        echo "<p>联系电话：<input type='text' name='phone' value='$phone'></p>";
//        echo "<p>在线时间：<input type='text' name='support_time' placeholder='示例  周一至周五：09:00-18:00' style='width: 230px' value='$support_time'></p>";
    ...
    public function saveOptions() {
        ...
        $qq_number_2    =  $_POST['qq_number_2'];
        $qq_number_3    =  $_POST['qq_number_3'];
        $qq_number_4    =  $_POST['qq_number_4'];
        $phone          =  $_POST['phone'];
        $support_time   =  $_POST['support_time'];
        $qq_number_1 ? update_option($this->option_qq_number_1, $qq_number_1) : null;
        $qq_number_2 ? update_option($this->option_qq_number_2, $qq_number_2) : null;
        $qq_number_3 ? update_option($this->option_qq_number_3, $qq_number_3) : null;
        $qq_number_4 ? update_option($this->option_qq_number_4, $qq_number_4) : null;
        $phone ? update_option($this->option_phone, $phone) : null;
        $support_time ? update_option($this->option_support_time, $support_time) : null;
    }
}
